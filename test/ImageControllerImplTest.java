...
/**
 * Represents the tests for the ImageControllerImpl class.
...
public class ImageControllerImplTest  {
  ...
  ImageModel onePixel;
  ImageView single;
  ImageController flowerControl;
  ImageController oneControl;
  Reader in;
  ...
  public void setUp() {
    ...
    in = new StringReader("");
    flowerControl = new ImageControllerImpl(flower, view, in);

    onePixel = new RGBModel(readFile("res/one_black_pixel.ppm"));
    single = new RGBView(append);
    oneControl = new ImageControllerImpl(onePixel, single, in);
  }
  ...
  public void constructFail() {
    this.setUp();
    ImageControllerImpl fail = new ImageControllerImpl(null, view, in);
  }

  @Test (expected = IllegalArgumentException.class)
  public void constructFail2() {
    this.setUp();
    ImageControllerImpl fail = new ImageControllerImpl(flower, null, in);
  }

  @Test (expected = IllegalArgumentException.class)
  public void constructFail3() {
    this.setUp();
    ImageControllerImpl fail = new ImageControllerImpl(flower, view, null);
  }
  ...
  @Test public void redTest() throws FileNotFoundException {
  ...
  @Test public void greenTest() throws FileNotFoundException {
  ...
  @Test public void blueTest() throws FileNotFoundException {
  ...
  @Test public void valueTest() throws FileNotFoundException {
  ...
  @Test public void intensityTest() throws FileNotFoundException {
  ...
  @Test public void lumaTest() throws FileNotFoundException {
  ...
  @Test public void horizontalTest() throws FileNotFoundException {
  ...
  @Test public void verticalTest() throws FileNotFoundException {
  ...
  @Test public void brightenTest() throws FileNotFoundException {
  ...
  @Test public void darkenTest() throws FileNotFoundException {
  ...
  @Test public void blurTest() throws FileNotFoundException {
  ...
  @Test public void sharpenTest() throws FileNotFoundException {
  ...
  @Test public void sepiaTest() throws FileNotFoundException {
  ...
  @Test public void greyTest() throws FileNotFoundException {
