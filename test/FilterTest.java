...
public class FilterTest {
  ...
  private final boolean[][] mask = {{true, true, true}, {true, true, true}, {true, true, true}};
  ...
  public void testBlurMask() {
    ...
    IPixel[][] blurred = pixelArrayFromChannelArrays(
        ...
        new int[][]{{85, 96, 57}, {96, 138, 106}, {84, 119, 96}},
        new int[][]{{76, 134, 112}, {69, 135, 130}, {42, 77, 88}});
    assertEquals(blur.applyFilter(new Image(3, 3, testArr), mask), new Image(3, 3, blurred));
  }
  ...
  public void testSharpenMask() {
    ...
    IPixel[][] sharpened = pixelArrayFromChannelArrays(
        ...
        new int[][]{{229, 255, 65, 64, 114}, {255, 255, 139, 132, 255}, {249, 255, 47, 27, 95},
            {223, 255, 119, 161, 89}, {107, 229, 209, 173, 216}});
    assertEquals(sharpen.applyFilter(new Image(5, 5, testArr), new boolean[][]{{true, true, true,
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testNullBlurMask() {
    blur.applyFilter(null, mask);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullSharpenMask() {
    sharpen.applyFilter(null, mask);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullMaskBlur() {
    blur.applyFilter(new Image(0, 0, new IPixel[0][0]), null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNullMaskSharpen() {
    sharpen.applyFilter(new Image(0, 0, new IPixel[0][0]), null);
  }
}
